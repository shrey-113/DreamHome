...
('O001', 'John', 'Doe', 'johndoe@email.com', '1234567890', '123 Main St', 'USA', '1980-01-01', 'Accountant', 'TAX001', '12345678', 'P001', 'Rent', '1 year lease'),
('O002', 'Jane', 'Smith', 'janesmith@email.com', '0987654321', '456 Oak St', 'USA', '1975-03-15', 'Lawyer', 'TAX002', '87654321', 'P002', 'Management', '2 year lease'),
('O003', 'David', 'Lee', 'davidlee@email.com', '5555555555', '789 Elm St', 'Canada', '1990-05-20', 'Engineer', 'TAX003', '11111111', 'P003', 'Rent', '6 month lease'),
('O004', 'Emma', 'Johnson', 'emmajohnson@email.com', '2222222222', '987 Maple St', 'UK', '1982-12-31', 'Doctor', 'TAX004', '33333333', 'P004', 'Management', '1 year lease'),
('O005', 'Alex', 'Garcia', 'alexgarcia@email.com', '4444444444', '555 Pine St', 'Mexico', '1978-08-08', 'Business Owner', 'TAX005', '55555555', 'P005', 'Rent', '3 month lease'),
('O006', 'Sophie', 'Brown', 'sophiebrown@email.com', '7777777777', '321 Cedar St', 'Australia', '1995-02-14', 'Artist', 'TAX006', '77777777', 'P006', 'Management', '2 year lease'),
('O007', 'Michael', 'Nguyen', 'michaelnguyen@email.com', '9999999999', '654 Birch St', 'Vietnam', '1988-07-17', 'Programmer', 'TAX007', '99999999', 'P007', 'Rent', '1 year lease');

INSERT INTO BranchOffice (BranchNumber, BranchAddress, City, ManagerID, TelephoneNumber, ManagerStartDate, ManagerBonus) VALUES
('B001', '1 Main Street', 'Glasgow', 'S001', '0141 123 4567', '2022-01-01', 5000.00),
('B002', '5 High Street', 'Edinburgh', 'S002', '0131 123 4567', '2022-01-01', 4500.00),
('B003', '10 George Square', 'Glasgow', 'S003', '0141 234 5678', '2022-01-01', 5500.00),
('B004', '15 Princes Street', 'Edinburgh', 'S004', '0131 234 5678', '2022-01-01', 4000.00),
('B005', '20 Buchanan Street', 'Glasgow', 'S005', '0141 345 6789', '2022-01-01', 6000.00),
('B006', '25 Rose Street', 'Edinburgh', 'S006', '0131 345 6789', '2022-01-01', 3500.00),
('B007', '30 Sauchiehall Street', 'Glasgow', 'S007', '0141 456 7890', '2022-01-01', 6500.00);

INSERT INTO Staff (StaffID, Firstname, LastName, Sex, Date_of_Birth, Position, Salary, BranchNumber, SupervisorID)
VALUES 
('S001', 'John', 'Doe', 'M', '1985-02-12', 'Manager', 75000.00, 'B001', NULL),
('S002', 'Jane', 'Doe', 'F', '1990-05-23', 'Supervisor', 50000.00, 'B001', 'S001'),
('S003', 'Mark', 'Smith', 'M', '1993-11-10', 'Assistant', 35000.00, 'B001', 'S002'),
('S004', 'Sarah', 'Johnson', 'F', '1987-09-05', 'Supervisor', 50000.00, 'B002', 'S001'),
('S005', 'Michael', 'Brown', 'M', '1991-07-20', 'Assistant', 35000.00, 'B002', 'S004'),
('S006', 'Emily', 'Davis', 'F', '1989-03-15', 'Assistant', 35000.00, 'B002', 'S004'),
('S007', 'David', 'Garcia', 'M', '1995-01-08', 'Supervisor', 50000.00, 'B003', 'S001'),
('S008', 'Sophia', 'Lee', 'F', '1994-06-18', 'Assistant', 35000.00, 'B003', 'S007'),
('S009', 'Matthew', 'Wilson', 'M', '1988-12-30', 'Assistant', 35000.00, 'B003', 'S007');
